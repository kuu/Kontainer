...
var FullBox = function (_Box) {
  ...
  function FullBox(type, props, version, flags) {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(FullBox).call(this, type, props));
  ...
  _createClass(FullBox, [{
    ...
    value: function serialize(buffer) {
      ...
      base += _Writer2.default.writeNumber(version, buffer, base, 1);
      ...
      base += _Writer2.default.writeNumber(flags, buffer, base, 3);
