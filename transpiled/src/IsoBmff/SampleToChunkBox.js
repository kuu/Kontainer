...
var SampleToChunkBox = (function (_FullBox) {
  function SampleToChunkBox(props) {
    ...
    _get(Object.getPrototypeOf(SampleToChunkBox.prototype), 'constructor', this).call(this, SampleToChunkBox.COMPACT_NAME, props, props.version, 0);
  }
  ...
  _createClass(SampleToChunkBox, [{
    ...
    value: function parse(buffer) {
      ...
      for (var i = 0; i < entryCount; i++) {
        ...
        firstChunk = _Reader$readNumber32[1];
        ...
        samplesPerChunk = _Reader$readNumber42[1];
        ...
        sampleDescriptionIndex = _Reader$readNumber52[1];
