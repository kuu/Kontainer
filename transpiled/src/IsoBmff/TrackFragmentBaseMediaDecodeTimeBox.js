...
var TrackFragmentBaseMediaDecodeTimeBox = function (_FullBox) {
  _inherits(TrackFragmentBaseMediaDecodeTimeBox, _FullBox);

  function TrackFragmentBaseMediaDecodeTimeBox(props) {
    _classCallCheck(this, TrackFragmentBaseMediaDecodeTimeBox);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(TrackFragmentBaseMediaDecodeTimeBox).call(this, TrackFragmentBaseMediaDecodeTimeBox.COMPACT_NAME, props, props.version, 0));
  }
  ...
  _createClass(TrackFragmentBaseMediaDecodeTimeBox, [{
    ...
    value: function serialize(buffer) {
      ...
      if (this.version === 1) {
        base += _Writer2.default.writeNumber(baseMediaDecodeTime, buffer, base, 8);
      } else {
        base += _Writer2.default.writeNumber(baseMediaDecodeTime, buffer, base, 4);
      }

      _get(Object.getPrototypeOf(TrackFragmentBaseMediaDecodeTimeBox.prototype), 'setSize', this).call(this, base - offset, buffer, offset);
    ...
    value: function parse(buffer) {
      ...
      if (props.version === 1) {
        var _Reader$readNumber = _Reader2.default.readNumber(buffer, base, 8);

        var _Reader$readNumber2 = _slicedToArray(_Reader$readNumber, 2);

        readBytesNum = _Reader$readNumber2[0];
        baseMediaDecodeTime = _Reader$readNumber2[1];
      } else {
        ...
        baseMediaDecodeTime = _Reader$readNumber4[1];
      }
      base += readBytesNum;
...
exports.default = TrackFragmentBaseMediaDecodeTimeBox;
...
TrackFragmentBaseMediaDecodeTimeBox.propTypes = {
  ...
  baseMediaDecodeTime: _PropTypes2.default.number.isRequired
};
