...
var TrackFragmentBaseMediaDecodeTimeBox = (function (_FullBox) {
  ...
  function TrackFragmentBaseMediaDecodeTimeBox(props) {
    ...
    _get(Object.getPrototypeOf(TrackFragmentBaseMediaDecodeTimeBox.prototype), 'constructor', this).call(this, TrackFragmentBaseMediaDecodeTimeBox.COMPACT_NAME, props, props.version, 0);
  }
  ...
  _createClass(TrackFragmentBaseMediaDecodeTimeBox, [{
    ...
    value: function parse(buffer) {
      ...
      if (this.version === 1) {
        ...
        baseMediaDecodeTime = _Reader$readNumber32[1];
      }
      base += readBytesNum;
