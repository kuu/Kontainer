...
var _AudioSampleEntry2 = require('./AudioSampleEntry');

var _AudioSampleEntry3 = _interopRequireDefault(_AudioSampleEntry2);
...
var MP4AudioSampleEntry = function (_AudioSampleEntry) {
  ...
  _createClass(MP4AudioSampleEntry, [{
    ...
    value: function parse(buffer) {
      ...
      var _AudioSampleEntry$par = _AudioSampleEntry3.default.parse(buffer, base);
...
}(_AudioSampleEntry3.default);

exports.default = MP4AudioSampleEntry;
...
MP4AudioSampleEntry.propTypes = {
  ...
  channelCount: _PropTypes2.default.oneOf([1, 2]),
